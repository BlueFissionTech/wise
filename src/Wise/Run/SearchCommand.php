<?php
// SearchCommand.php
namespace BlueFission\BlueCore\Business\Commands;

use BlueFission\Services\Service;
use BlueFission\BlueCore\Business\Services\GoogleSearchService;
use BlueFission\BlueCore\Business\Services\DuckDuckGoSearchService;
